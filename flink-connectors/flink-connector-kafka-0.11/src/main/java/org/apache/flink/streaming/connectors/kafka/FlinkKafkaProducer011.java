...
/**
 * Flink Sink to produce data into a Kafka topic. This producer is compatible with Kafka 0.11.x
 *
 ...
 */
public class FlinkKafkaProducer011<T> extends StreamSink<T> implements SinkFunction<T>, RichFunction {
	 ...
	 */
	public static <T> FlinkKafkaProducer011Configuration<T> writeToKafkaWithTimestamps(DataStream<T> inStream,
																					String topicId,
	...
	public static <T> FlinkKafkaProducer011Configuration<T> writeToKafkaWithTimestamps(DataStream<T> inStream,
		...
		FlinkKafkaProducer011<T> kafkaProducer = new FlinkKafkaProducer011<>(topicId, serializationSchema, producerConfig, customPartitioner);
		SingleOutputStreamOperator<Object> transformation = inStream.transform("FlinKafkaProducer 0.11.x", objectTypeInfo, kafkaProducer);
		return new FlinkKafkaProducer011Configuration<>(transformation, kafkaProducer);
	}
	 ...
	 */
	public FlinkKafkaProducer011(String brokerList, String topicId, SerializationSchema<T> serializationSchema) {
	 ...
	 */
	public FlinkKafkaProducer011(String topicId, SerializationSchema<T> serializationSchema, Properties producerConfig) {
	 ...
	 */
	public FlinkKafkaProducer011(String topicId, SerializationSchema<T> serializationSchema, Properties producerConfig, FlinkKafkaPartitioner<T> customPartitioner) {
	 ...
	 */
	public FlinkKafkaProducer011(String brokerList, String topicId, KeyedSerializationSchema<T> serializationSchema) {
	 ...
	 * 			Properties with the producer configuration.
	 */
	public FlinkKafkaProducer011(String topicId, KeyedSerializationSchema<T> serializationSchema, Properties producerConfig) {
	 ...
	 */
	public FlinkKafkaProducer011(String topicId, KeyedSerializationSchema<T> serializationSchema, Properties producerConfig, FlinkKafkaPartitioner<T> customPartitioner) {
	 ...
	 *              {@link FlinkKafkaProducer011#FlinkKafkaProducer011(String, SerializationSchema, Properties, FlinkKafkaPartitioner)} instead.
	 */
	@Deprecated
	public static <T> FlinkKafkaProducer011Configuration<T> writeToKafkaWithTimestamps(DataStream<T> inStream,
																					String topicId,
		...
		GenericTypeInfo<Object> objectTypeInfo = new GenericTypeInfo<>(Object.class);
		FlinkKafkaProducer011<T> kafkaProducer =
				new FlinkKafkaProducer011<>(topicId, serializationSchema, producerConfig, new FlinkKafkaDelegatePartitioner<>(customPartitioner));
		SingleOutputStreamOperator<Object> transformation = inStream.transform("FlinKafkaProducer 0.11.x", objectTypeInfo, kafkaProducer);
		return new FlinkKafkaProducer011Configuration<>(transformation, kafkaProducer);
	}
	 ...
	 */
	@Deprecated
	public FlinkKafkaProducer011(String topicId, SerializationSchema<T> serializationSchema, Properties producerConfig, KafkaPartitioner<T> customPartitioner) {
		this(topicId, new KeyedSerializationSchemaWrapper<>(serializationSchema), producerConfig, customPartitioner);
	}
	 ...
	 */
	@Deprecated
	public FlinkKafkaProducer011(String topicId, KeyedSerializationSchema<T> serializationSchema, Properties producerConfig, KafkaPartitioner<T> customPartitioner) {
		// We create a Kafka 09 producer instance here and only "override" (by intercepting) the
		// invoke call.
	 ...
	 */
	public static class FlinkKafkaProducer011Configuration<T> extends DataStreamSink<T> {

		private final FlinkKafkaProducerBase wrappedProducerBase;
		private final FlinkKafkaProducer011 producer;

		private FlinkKafkaProducer011Configuration(DataStream stream, FlinkKafkaProducer011<T> producer) {
