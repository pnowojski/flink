 ...
 */
public class Kafka011Fetcher<T> extends Kafka09Fetcher<T> {
	...
	protected void emitRecord(
		...
		// we attach the Kafka 0.11 timestamp here
		emitRecordWithTimestamp(record, partition, offset, consumerRecord.timestamp());
	}

	/**
	 * This method needs to be overridden because Kafka broke binary compatibility between 0.9 and 0.11,
	 * changing binary signatures.
	 */
	@Override
	protected KafkaConsumerCallBridge011 createCallBridge() {
		return new KafkaConsumerCallBridge011();
	}
