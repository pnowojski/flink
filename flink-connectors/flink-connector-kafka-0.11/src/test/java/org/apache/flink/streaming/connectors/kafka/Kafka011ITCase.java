...
public class Kafka011ITCase extends KafkaConsumerTestBase {
	...
	public void testTimestamps() throws Exception {
		...
		FlinkKafkaProducer011.FlinkKafkaProducer011Configuration prod = FlinkKafkaProducer011.writeToKafkaWithTimestamps(streamWithTimestamps, topic, new KeyedSerializationSchemaWrapper<>(longSer), standardProps, new FlinkKafkaPartitioner<Long>() {
