...
class MultiInputTestOperator extends AbstractStreamOperatorV2<TestEvent>
        implements MultipleInputStreamOperator<TestEvent>,
                ProcessingTimeCallback,
                BoundedMultiInput {
    private final List<Input> inputs;
    private final TestEventQueue eventQueue;
    private final String operatorId;
    private final Map<String, DataSentEvent.LastVertexDataInfo> lastDataReceived;
    ...
    public MultiInputTestOperator(
            int numInputs,
            StreamOperatorParameters<TestEvent> params,
    ...
    private static class TestEventInput implements Input<TestEvent> {
        private final int id;
        private final TestEventQueue eventQueue;
        private final Output<StreamRecord<TestEvent>> output;
        private final String operatorId;
        ...
        public TestEventInput(
                int id,
                TestEventQueue eventQueue,
                Output<StreamRecord<TestEvent>> output,
                String operatorId,
                int subtaskIndex,
                Map<String, DataSentEvent.LastVertexDataInfo> lastDataReceived,
        ...
        public void processElement(StreamRecord<TestEvent> element) throws Exception {
            ...
            if (e instanceof DataSentEvent) {
                lastDataReceived
                        .computeIfAbsent(
                                e.operatorId, ign -> new DataSentEvent.LastVertexDataInfo())
                        .bySubtask
        ...
        @Override
        public void setKeyContextElement(StreamRecord<TestEvent> record) {}
    }
}
