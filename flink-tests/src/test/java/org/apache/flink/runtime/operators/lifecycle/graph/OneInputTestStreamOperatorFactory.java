...
class OneInputTestStreamOperatorFactory
        implements OneInputStreamOperatorFactory<TestEvent, TestEvent>, ProcessingTimeServiceAware {
    ...
    public <T extends StreamOperator<TestEvent>> T createStreamOperator(
            StreamOperatorParameters<TestEvent> parameters) {
