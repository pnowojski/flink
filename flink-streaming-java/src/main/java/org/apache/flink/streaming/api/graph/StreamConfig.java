...
public class StreamConfig implements Serializable {
	...
	private static final String NUMBER_OF_NETWORK_INPUTS = "numberOfInputs";
	...
	public <T> TypeSerializer<T> getTypeSerializerIn(int index, ClassLoader cl) {
		...
		return (TypeSerializer<T>) ((NetworkInput) inputs[index]).typeSerializer;
	}
	...
	/**
	 * A representation of a Network {@link Input}.
	 */
	public static class NetworkInput extends Input {
		private final TypeSerializer<?> typeSerializer;
		private int inputGateIndex;

		public NetworkInput(TypeSerializer<?> typeSerializer, int inputGateIndex) {
