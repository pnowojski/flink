...
-`taskmanager.network.credit-based.enabled`: The switch that is used to control whether to enable new credit-based flow control or not. The default value is true to enable this new feature. In order to get better performance, the above two parameters should be tuned properly.
