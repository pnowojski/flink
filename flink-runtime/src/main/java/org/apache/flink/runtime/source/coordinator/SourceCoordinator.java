...
public class SourceCoordinator<SplitT extends SourceSplit, EnumChkT>
    ...
    public static final WatermarkAlignmentParams WATERMARK_ALIGNMENT_DISABLED =
            new WatermarkAlignmentParams(Long.MAX_VALUE, "");
    ...
    public SourceCoordinator(
        ...
        this(
                ...
                new WatermarkAlignmentParams(
                        10_000L, "watermark-group-1")); // TODO: remove or replace with
    ...
    public static class WatermarkAlignmentParams {
        ...
        public WatermarkAlignmentParams(long maxAllowedWatermarkDrift, String watermarkGroup) {
